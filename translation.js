...
const translationSettingList = [
    ...
    {
        "description": "左侧菜单栏",
        "selector": "body.desktop #launcher-pane,body.mobile #global-buttons,#left-pane .tree-actions",
        "method": "static",
        "translation": [
            ...
            { "searchWord": "Switch to mobile version", "replaceWord": "切换移动端模式" },
            { "searchWord": "Switch to desktop version", "replaceWord": "切换桌面端模式" },
            { "searchWord": "Show Help", "replaceWord": "显示帮助" },
            { "searchWord": "About Trilium Notes", "replaceWord": "关于 Trilium" },
            { "searchWord": "Logout", "replaceWord": "注销" },
            { "searchWord": "New note", "replaceWord": "新建笔记" },
            { "searchWord": "Search", "replaceWord": "搜索" },
            { "searchWord": "Jump to note", "replaceWord": "跳转到笔记" },
            { "searchWord": "Global Note Map", "replaceWord": "笔记地图" },
            { "searchWord": "Show recent changes", "replaceWord": "最近更改" },
            { "searchWord": "Calendar", "replaceWord": "日历" },
            { "searchWord": "Today", "replaceWord": "今天" },
            { "searchWord": "New task", "replaceWord": "新任务" },
            { "searchWord": "Weight Tracker", "replaceWord": "体重追踪" },
            { "searchWord": "TODO", "replaceWord": "待办" },
            { "searchWord": "Click to enter protected session", "replaceWord": "点击进入保护会话" },
            { "searchWord": "Hide panel", "replaceWord": "隐藏" },
            { "searchWord": "Collapse note tree", "replaceWord": "折叠笔记树" },
            { "searchWord": "Scroll to active note", "replaceWord": "找到当前笔记" },
            { "searchWord": "Plugin buttons", "replaceWord": "插件按钮" },
            { "searchWord": "No plugin buttons loaded yet", "replaceWord": "当前没有加载的插件按钮" },
            { "searchWord": "Tree settings", "replaceWord": "目录树设置" },
            { "searchWord": "Enter protected session", "replaceWord": "进入保护会话" },
        ],
    },
    {
        "description": "“关于”对话框",
    ...
    },
    {
        ...
        "translation": [
            ...
            { "searchWord": "Hide images included in a note", "replaceWord": "隐藏笔记中的图片" },
            { "searchWord": "Automatically collapse notes", "replaceWord": "自动折叠笔记" },
    ...
    },
    {
        ...
        "translation": [
            ...
            { "searchWord": "Open note externally", "replaceWord": "用外部程序打开笔记" },
    ...
    },
    {
        ...
        "translation": [
            ...
            { "searchWord": "Bookmark this note to the left side panel", "replaceWord": "将此笔记添加到左侧书签栏" },
            { "searchWord": "Remove bookmark", "replaceWord": "移除书签" },
            ...
            { "searchWord": "Type the labels and relations here", "replaceWord": "在此输入键值对" },
            { "searchWord": "Save attributes", "replaceWord": "保存属性" },
            { "searchWord": "Add a new attribute", "replaceWord": "添加新属性" },
            { "searchWord": "No inherited attributes", "replaceWord": "当前没有继承的属性" },
            { "searchWord": "This note is placed into the following paths", "replaceWord": "这个笔记已被放到以下路径中" },
            { "searchWord": "Clone note to new location...", "replaceWord": "克隆到新路径..." },
            { "searchWord": "Link Map", "replaceWord": "关联图" },
            { "searchWord": "Tree map", "replaceWord": "树状图" },
            { "searchWord": "Open full", "replaceWord": "展开" },
            { "searchWord": "Collapse to normal size", "replaceWord": "收缩" },
            { "searchWord": "Note ID", "replaceWord": "笔记ID" },
            { "searchWord": "Created", "replaceWord": "创建于" },
            { "searchWord": "Modified", "replaceWord": "最后修改于" },
            { "searchWord": "Type", "replaceWord": "笔记类型" },
            { "searchWord": "Note size", "replaceWord": "空间占用" },
            { "searchWord": "calculate", "replaceWord": "计算" },
            { "searchWord": "Fast search option disables full text search of note contents which might speed up searching in large databases.", "replaceWord": "\"快速搜索\"选项禁用了笔记内容的全文搜索, 这可能会加快大型数据库中的搜索速度." },
            { "searchWord": "Take only first X specified results.", "replaceWord": "只取前N条结果." },
            { "searchWord": "Debug will print extra debugging information into the console to aid in debugging complex queries.", "replaceWord": "调试会将更多调试信息打印到控制台中, 以帮助调试复杂的查询." },
            { "searchWord": "To access the debug information, execute query and click on \"Show backend log\" in top left corner.", "replaceWord": ".要访问调试信息, 请执行查询, 然后单击左上角的\"显示后端日志\"." },
            ...
            { "searchWord": "Date of last modification", "replaceWord": "最后修改日期" },
            { "searchWord": "Note content size including revisions", "replaceWord": "笔记内容大小(包括历史)" },
            ...
            { "searchWord": "Number of relations targeting the note", "replaceWord": "指向笔记的关系数" },
            ...
            { "searchWord": "Open a note by typing the note's title into the input below or choose a note in the tree.", "replaceWord": "在下方输入笔记名称或者点树形图来打开笔记." },
        ],
    },
    {
        "description": "笔记正文部分",
        ...
        "method": "tab",
        "translation": [
            { "searchWord": "Type the content of your note here", "replaceWord": "在此输入笔记内容" },
            { "searchWord": "Execute", "replaceWord": "运行" },
            { "searchWord": "API docs", "replaceWord": "API文档" },
        ],
    },
    {
        "description": "右键菜单",
        ...
        "monitor": ["attributes"],
        "translation": [
            { "searchWord": "Open in a new tab", "replaceWord": "新建标签页打开" },
            { "searchWord": "Open in a new split", "replaceWord": "新建分割页打开" },
            { "searchWord": "Insert note after", "replaceWord": "在下方新建笔记" },
            { "searchWord": "Insert child note", "replaceWord": "新建子笔记" },
            { "searchWord": "Delete this note", "replaceWord": "删除" },
            { "searchWord": "Delete", "replaceWord": "删除" },
            { "searchWord": "Search in subtree", "replaceWord": "在子目录中搜索" },
            { "searchWord": "Hoist note", "replaceWord": "提升笔记" },
            { "searchWord": "Edit branch prefix", "replaceWord": "编辑分支前缀" },
            { "searchWord": "Advanced", "replaceWord": "高级" },
            { "searchWord": "Expand subtree", "replaceWord": "展开子目录树" },
            { "searchWord": "Collapse subtree", "replaceWord": "折叠子目录树" },
            { "searchWord": "Force note sync", "replaceWord": "强制同步笔记" },
            { "searchWord": "Sort by", "replaceWord": "排序" },
            { "searchWord": "Recent changes in subtree", "replaceWord": "最近子目录树的变更" },
            { "searchWord": "Protect subtree", "replaceWord": "保护子目录树" },
            { "searchWord": "Unprotect subtree", "replaceWord": "取消保护子目录树" },
            { "searchWord": "Copy / clone", "replaceWord": "复制/克隆" },
            { "searchWord": "Clone to", "replaceWord": "克隆到" },
            { "searchWord": "Cut", "replaceWord": "剪切" },
            { "searchWord": "Move to", "replaceWord": "移动到" },
            { "searchWord": "Paste into", "replaceWord": "粘贴到子目录中" },
            { "searchWord": "Paste after", "replaceWord": "粘贴为并列" },
            { "searchWord": "Duplicate subtree", "replaceWord": "复制子目录树" },
            { "searchWord": "Export", "replaceWord": "导出" },
            { "searchWord": "Import into note", "replaceWord": "导入到笔记" },
            { "searchWord": "Apply bulk actions", "replaceWord": "应用批量操作" },
            { "searchWord": "Move this tab to a new window", "replaceWord": "将标签页移动到新窗口" },
            { "searchWord": "Close all tabs", "replaceWord": "关闭所有标签页" },
            { "searchWord": "Close all tabs except for this", "replaceWord": "关闭除当前页以外的标签页" },
        ],
    },
];

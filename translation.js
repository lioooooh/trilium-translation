...
const translationSettingList = [
    ...
    },
    {
        ...
        "translation": [
            ...
            {
                'searchWord': 'Click to enter protected session',
                'replaceWord': '点击进入保护会话',
            },
            { 'searchWord': 'Hide panel', 'replaceWord': '隐藏' },
            { 'searchWord': 'Collapse note tree', 'replaceWord': '折叠笔记树' },
            {
                'searchWord': 'Scroll to active note',
                'replaceWord': '找到当前笔记',
            },
            { 'searchWord': 'Plugin buttons', 'replaceWord': '插件按钮' },
            {
                'searchWord': 'No plugin buttons loaded yet',
                'replaceWord': '当前没有加载的插件按钮',
            },
            { 'searchWord': 'Tree settings', 'replaceWord': '目录树设置' },
            {
                'searchWord': 'Enter protected session',
                'replaceWord': '进入保护会话',
            },
        ],
    },
